  ...
  return (
    <header className="p-4 flex justify-center items-center">
      <Link href={"/"} className="w-full flex gap-2 justify-start items-center">
        ...
        <span className="font-semibold dark:text-white">NebulaNote</span>
      </Link>
      ...
      {/* Navigation Menu End */}
      <aside className="flex w-full gap-6 justify-end">
        <Link href={"/login"}>
          <Button variant={"btn-secondary"} className="p-1 hidden sm:block text-base">
            Login
          </Button>
        </Link>
        <Link href={"/signup"}>
