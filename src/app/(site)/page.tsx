  ...
  return (
    ...
    "
              ...
              {CLIENTS.map((client, index) => (
                ...
                >
                  <Image
                    ...
                    alt={client.alt}
                    width={400}
                    className="object-contain max-w-none w-[150px]"
                  />
                </div>
              ))}
            </div>
      ...
      <section className="px-4 sm:px-6 flex justify-center items-center flex-col relative">
        ...
        "
        >
          <Image src={Cal} alt="Another Banner" className="rounded-2x;" />
        </div>
      </section>
          ...
          {[1, 2].map((arr) => (
            <div
              ...
              className={cn(
                ...
                {
                  "flex-row-reverse": arr == 2,
                  "animate-[slide_250s_linear_infinite]": true,
                  "animate-[slide_250s_linear_infinite_reverse]": arr == 2,
                  "ml-[100vw]": arr == 2,
                }
              )}
            >
